...
final class YPLibraryView: UIView {
    ...
    let assetZoomableViewMinimalVisibleHeight: CGFloat  = 0 //50 mini display image when scroll
    ...
    func setupMaxNumberOfItemsView() {
        ...
        if #available(iOS 11.0, *) {
            maxNumberWarningView.Top == safeAreaLayoutGuide.Bottom // warning bottom max selected image 40
            maxNumberWarningLabel.centerHorizontally().top(11)
        } else {
            maxNumberWarningView.height(40) //warning 40
...
extension YPLibraryView {
    ...
    func currentCropRect() -> CGRect {
        ...
        // New - TuyNuy - Fix Crop
        return CGRect(x: 0, y: 0, width: cropView.contentSize.width, height: cropView.contentSize.height)
