...
class InstaImagePicker {
    ...
    class func showInstaPopupImage(owner : UIViewController,completeBlock : ((UIImage) -> Void)?)  {
...
//        UIBarButtonItem.appearance().setTitleTextAttributes(attrsBarButton, for: .normal)
    ...
    class func showInstaPopupMultipleImage(owner : UIViewController, isCreate: YPPickerScreen, maxImages: Int,completeBlock : (([UIImage]) -> Void)?)  {
        ...
        config.wordings.next                            = "select"
        config.wordings.cancel                          = "sgfs"//"cancel_btn".localized // "back".localized
        config.wordings.cameraTitle                     = "camera"
